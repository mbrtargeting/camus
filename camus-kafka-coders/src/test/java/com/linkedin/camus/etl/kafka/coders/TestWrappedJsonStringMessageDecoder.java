...
public class TestWrappedJsonStringMessageDecoder {
    ...
    public void testWrapFormat() {
        ...
        CamusWrapper actualResult = testDecoder
                .decode(new TestMessage().setPayload(bytePayload).setKey(keyPayload).setChecksum(1)
                                .setPartition(0).setTopic("TEST").setOffset(44));
        assertEquals(
                "{\"topic\":\"TEST\",\"partition\":0,\"offset\":44,\"checksum\":1,\"payload\":{\"timestamp\":1406947271534,\"myData\":\"myValue\"},\"key\":{\"id\":1},\"timestamp\":1406947271534}",
                actualResult.getRecord());
    }
