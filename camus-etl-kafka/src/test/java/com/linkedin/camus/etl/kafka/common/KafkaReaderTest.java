...
public class KafkaReaderTest {
    ...
    public void before() throws Exception {
        ...
        try {
            Class<?> taskAttemptContextImplClass = Class
                    .forName("org.apache.hadoop.mapreduce.task.TaskAttemptContextImpl");
            context =
                    (TaskAttemptContext) taskAttemptContextImplClass
            ...
            context =
                    (TaskAttemptContext) Class
                            .forName("org.apache.hadoop.mapreduce.TaskAttemptContext")
    ...
    public void testFetchFailure()
        ...
        EasyMock.expect(consumer.send((TopicMetadataRequest) EasyMock.anyObject()))
