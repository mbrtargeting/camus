...
public class EtlRequest implements CamusRequest {
     ...
     * @param leaderId  The leader broker for this partition and topic
     * @param partition The partition to pull
     */
     ...
     *
     * @param topic     The topic name
     * @param leaderId  The leader broker for this topic and partition
     * @param partition The partition to pull
     * @param brokerUri The uri for the broker.
     */
    public EtlRequest(JobContext context, String topic, String leaderId, int partition,
                      URI brokerUri) {
    ...
    public String toString() {
        return topic + "\turi:" + (uri != null ? uri.toString() : "") + "\tleader:" + leaderId
               + "\tpartition:" + partition
               + "\tearliest_offset:" + getEarliestOffset() + "\toffset:" + offset
        ...
        if (earliestOffset == -2 && uri != null) {
            ...
            OffsetResponse response =
                    consumer.getOffsetsBefore(
                            new OffsetRequest(offsetInfo, kafka.api.OffsetRequest.CurrentVersion(),
                                              "hadoop-etl"));
