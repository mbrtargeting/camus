...
abstract public class BaseTimeBasedPartitioner extends Partitioner {
     ...
     *
     * @param outfilePartitionMillis duration of a partition, e.g. {@code 3,600,000} for hour
     *                               partitions
    ...
    protected void init(long outfilePartitionMillis, String destSubTopicPathFormat, Locale locale,
        ...
        this.outputDirFormatter = DateUtils
                .getDateTimeFormatter(destSubTopicPathFormat, outputTimeZone).withLocale(locale);
    }
